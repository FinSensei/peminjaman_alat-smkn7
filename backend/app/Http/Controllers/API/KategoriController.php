...
class KategoriController extends Controller
{
    ...
    { 
        $kategori = request()->has('page') || request()->has('per_page') ? Kategori::latest()->paginate(request()->input('per_page',15))->withQueryString() : Kategori::latest()->get(); 
    ...
    { 
        ...
        return response()->json(['message' => 'Kategori berhasil ditambahkan.','data' => new KategoriResource($kategori) 
        ], 201); 
    } 
    ...
    { 
        ...
        return response()->json(['message' => 'Kategori berhasil diperbarui.','data' => new KategoriResource($kategori) 
        ]); 
    } 
